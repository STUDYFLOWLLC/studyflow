...
class EnterFront extends React.Component<Props, State> {
  constructor(props: Props) {
    super(props)
    this.onChangeHandler = this.onChangeHandler.bind(this)
    this.state = {
      focused: false,
      html: props.flashcard.Front,
      uploading: false,
    }
  }
      ...
      <div className="my-2">
        ...
        >
          {({ getRootProps, getInputProps, isDragActive }) => (
            <div {...getRootProps()}>
              {(isDragActive || uploading || flashcard.FrontImageUrl) && (
                <div>
              ...
              <div>
                <div className="min-h-8 relative">
                  <ContentEditable
                    ...
                    placeholder="Enter term, image, etc."
