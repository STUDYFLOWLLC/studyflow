...
import { removeFriendship } from 'utils/social/friendshipHandlers'
...
export default function AcceptedFriend({ friendship, displayUser }: Props) {
    ...
    >
      ...
      <div className="flex">
        <p
          ...
          onClick={() => removeFriendship(friendship, friends, mutateFriends)}
          onKeyDown={() => removeFriendship(friendship, friends, mutateFriends)}
        >
          Remove
        </p>
      </div>
