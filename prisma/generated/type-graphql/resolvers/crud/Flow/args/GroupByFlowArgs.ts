...
export class GroupByFlowArgs {
  ...
  by!: Array<"FlowID" | "CreatedTime" | "LastOpened" | "UserEnteredDate" | "Type" | "Title" | "Trashed" | "Visibility" | "WasAutomated" | "Body" | "DeletedTime" | "ForeignLink" | "FK_CourseOnTermID" | "FK_UserID">;
