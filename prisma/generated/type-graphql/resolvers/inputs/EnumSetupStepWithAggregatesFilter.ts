...
import { NestedEnumSetupStepWithAggregatesFilter } from "../inputs/NestedEnumSetupStepWithAggregatesFilter";
import { NestedIntFilter } from "../inputs/NestedIntFilter";
import { SetupStep } from "../../enums/SetupStep";

@TypeGraphQL.InputType("EnumSetupStepWithAggregatesFilter", {
  isAbstract: true
})
export class EnumSetupStepWithAggregatesFilter {
