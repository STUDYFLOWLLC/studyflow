...
@TypeGraphQL.InputType("CourseOnTermAutomationUpdateManyWithWhereWithoutFK_CourseOnTermInput", {
  isAbstract: true
})
export class CourseOnTermAutomationUpdateManyWithWhereWithoutFK_CourseOnTermInput {
