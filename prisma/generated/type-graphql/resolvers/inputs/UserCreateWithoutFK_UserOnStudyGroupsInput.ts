...
import { TermCreateNestedManyWithoutFK_UserInput } from "./TermCreateNestedManyWithoutFK_UserInput"

@TypeGraphQL.InputType("UserCreateWithoutFK_UserOnStudyGroupsInput", {
  isAbstract: true
})
export class UserCreateWithoutFK_UserOnStudyGroupsInput {
