...
@TypeGraphQL.InputType("AutomationLogUpsertWithWhereUniqueWithoutFK_CourseOnTermAutomationInput", {
  isAbstract: true
})
export class AutomationLogUpsertWithWhereUniqueWithoutFK_CourseOnTermAutomationInput {
  ...
  update!: AutomationLogUpdateWithoutFK_CourseOnTermAutomationInput;
