...
@TypeGraphQL.InputType("ProfessorsOnCoursesUpdateManyWithWhereWithoutFK_ProfessorInput", {
  isAbstract: true
})
export class ProfessorsOnCoursesUpdateManyWithWhereWithoutFK_ProfessorInput {
