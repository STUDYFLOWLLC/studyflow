...
import { NestedEnumTermTypeNullableWithAggregatesFilter } from "../inputs/NestedEnumTermTypeNullableWithAggregatesFilter";
import { NestedIntNullableFilter } from "../inputs/NestedIntNullableFilter";
import { TermType } from "../../enums/TermType";

@TypeGraphQL.InputType("EnumTermTypeNullableWithAggregatesFilter", {
  isAbstract: true
})
export class EnumTermTypeNullableWithAggregatesFilter {
