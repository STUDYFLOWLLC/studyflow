...
const modelsInfo = {
  ...
  BugReport: ["BugReportID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  FeatureRequest: ["FeatureRequestID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"]
};
...
const outputsInfo = {
  ...
  BugReportGroupBy: ["BugReportID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateFeatureRequest: ["_count", "_avg", "_sum", "_min", "_max"],
  FeatureRequestGroupBy: ["FeatureRequestID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  BugReportCountAggregate: ["BugReportID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body", "_all"],
  BugReportAvgAggregate: ["FK_UserID"],
  BugReportSumAggregate: ["FK_UserID"],
  BugReportMinAggregate: ["BugReportID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  BugReportMaxAggregate: ["BugReportID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  FeatureRequestCountAggregate: ["FeatureRequestID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body", "_all"],
  FeatureRequestAvgAggregate: ["FK_UserID"],
  FeatureRequestSumAggregate: ["FK_UserID"],
  FeatureRequestMinAggregate: ["FeatureRequestID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  FeatureRequestMaxAggregate: ["FeatureRequestID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"]
};
...
const inputsInfo = {
  ...
  BugReportWhereInput: ["AND", "OR", "NOT", "BugReportID", "CreatedTime", "DeletedTime", "FK_User", "FK_UserID", "Title", "Body"],
  BugReportOrderByWithRelationInput: ["BugReportID", "CreatedTime", "DeletedTime", "FK_User", "FK_UserID", "Title", "Body"],
  BugReportWhereUniqueInput: ["BugReportID"],
  BugReportOrderByWithAggregationInput: ["BugReportID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body", "_count", "_avg", "_max", "_min", "_sum"],
  BugReportScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "BugReportID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  FeatureRequestWhereInput: ["AND", "OR", "NOT", "FeatureRequestID", "CreatedTime", "DeletedTime", "FK_User", "FK_UserID", "Title", "Body"],
  FeatureRequestOrderByWithRelationInput: ["FeatureRequestID", "CreatedTime", "DeletedTime", "FK_User", "FK_UserID", "Title", "Body"],
  FeatureRequestWhereUniqueInput: ["FeatureRequestID"],
  FeatureRequestOrderByWithAggregationInput: ["FeatureRequestID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body", "_count", "_avg", "_max", "_min", "_sum"],
  FeatureRequestScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "FeatureRequestID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  ...
  BugReportCreateInput: ["BugReportID", "CreatedTime", "DeletedTime", "FK_User", "Title", "Body"],
  BugReportUpdateInput: ["BugReportID", "CreatedTime", "DeletedTime", "FK_User", "Title", "Body"],
  BugReportCreateManyInput: ["BugReportID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  BugReportUpdateManyMutationInput: ["BugReportID", "CreatedTime", "DeletedTime", "Title", "Body"],
  FeatureRequestCreateInput: ["FeatureRequestID", "CreatedTime", "DeletedTime", "FK_User", "Title", "Body"],
  FeatureRequestUpdateInput: ["FeatureRequestID", "CreatedTime", "DeletedTime", "FK_User", "Title", "Body"],
  FeatureRequestCreateManyInput: ["FeatureRequestID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  FeatureRequestUpdateManyMutationInput: ["FeatureRequestID", "CreatedTime", "DeletedTime", "Title", "Body"],
  ...
  BugReportCountOrderByAggregateInput: ["BugReportID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  BugReportAvgOrderByAggregateInput: ["FK_UserID"],
  BugReportMaxOrderByAggregateInput: ["BugReportID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  BugReportMinOrderByAggregateInput: ["BugReportID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  BugReportSumOrderByAggregateInput: ["FK_UserID"],
  FeatureRequestCountOrderByAggregateInput: ["FeatureRequestID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  FeatureRequestAvgOrderByAggregateInput: ["FK_UserID"],
  FeatureRequestMaxOrderByAggregateInput: ["FeatureRequestID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  FeatureRequestMinOrderByAggregateInput: ["FeatureRequestID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  ...
  BugReportCreateWithoutFK_UserInput: ["BugReportID", "CreatedTime", "DeletedTime", "Title", "Body"],
  BugReportCreateOrConnectWithoutFK_UserInput: ["where", "create"],
  BugReportCreateManyFK_UserInputEnvelope: ["data", "skipDuplicates"],
  FeatureRequestCreateWithoutFK_UserInput: ["FeatureRequestID", "CreatedTime", "DeletedTime", "Title", "Body"],
  ...
  BugReportScalarWhereInput: ["AND", "OR", "NOT", "BugReportID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  ...
  FeatureRequestScalarWhereInput: ["AND", "OR", "NOT", "FeatureRequestID", "CreatedTime", "DeletedTime", "FK_UserID", "Title", "Body"],
  ...
  BugReportCreateManyFK_UserInput: ["BugReportID", "CreatedTime", "DeletedTime", "Title", "Body"],
  FeatureRequestCreateManyFK_UserInput: ["FeatureRequestID", "CreatedTime", "DeletedTime", "Title", "Body"],
  ...
  BugReportUpdateWithoutFK_UserInput: ["BugReportID", "CreatedTime", "DeletedTime", "Title", "Body"],
  FeatureRequestUpdateWithoutFK_UserInput: ["FeatureRequestID", "CreatedTime", "DeletedTime", "Title", "Body"],
