...
const inputsInfo = {
  ...
  TaskCreateInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_User", "FK_Flow", "FK_CourseOnTerm"],
  TaskUpdateInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_User", "FK_Flow", "FK_CourseOnTerm"],
  TaskCreateManyInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_UserID", "FK_FlowID", "FK_CourseOnTermID"],
  TaskUpdateManyMutationInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate"],
  ...
  TaskCreateWithoutFK_UserInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_Flow", "FK_CourseOnTerm"],
  ...
  TaskCreateWithoutFK_CourseOnTermInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_User", "FK_Flow"],
  ...
  TaskCreateWithoutFK_FlowInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_User", "FK_CourseOnTerm"],
  ...
  TaskCreateWithoutFK_TaskLabelInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_User", "FK_Flow", "FK_CourseOnTerm"],
  TaskCreateOrConnectWithoutFK_TaskLabelInput: ["where", "create"],
  TaskUpsertWithoutFK_TaskLabelInput: ["update", "create"],
  TaskUpdateWithoutFK_TaskLabelInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_User", "FK_Flow", "FK_CourseOnTerm"],
  ...
  TaskUpdateWithoutFK_UserInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_Flow", "FK_CourseOnTerm"],
  ...
  TaskUpdateWithoutFK_CourseOnTermInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_User", "FK_Flow"],
  ...
  TaskUpdateWithoutFK_FlowInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_User", "FK_CourseOnTerm"],
