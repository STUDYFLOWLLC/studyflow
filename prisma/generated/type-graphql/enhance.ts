...
const relationResolversInfo = {
  ...
  School: ["FK_Course"],
  Professor: ["FK_Course"],
  Flow: ["FK_FlashCardStacks", "CourseOnTerm"],
...
const modelsInfo = {
  ...
  Flow: ["FlowID", "CreatedTime", "Title", "Body", "Visibility", "courseOnTermCourseOnTermID"],
...
const outputsInfo = {
  ...
  FlowGroupBy: ["FlowID", "CreatedTime", "Title", "Body", "Visibility", "courseOnTermCourseOnTermID", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  FlowCountAggregate: ["FlowID", "CreatedTime", "Title", "Body", "Visibility", "courseOnTermCourseOnTermID", "_all"],
  FlowAvgAggregate: ["FlowID", "courseOnTermCourseOnTermID"],
  FlowSumAggregate: ["FlowID", "courseOnTermCourseOnTermID"],
  FlowMinAggregate: ["FlowID", "CreatedTime", "Title", "Body", "Visibility", "courseOnTermCourseOnTermID"],
  FlowMaxAggregate: ["FlowID", "CreatedTime", "Title", "Body", "Visibility", "courseOnTermCourseOnTermID"],
...
const inputsInfo = {
  UserWhereInput: ["AND", "OR", "NOT", "UserID", "CreatedTime", "SetupComplete", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_Terms"],
  UserOrderByWithRelationInput: ["UserID", "CreatedTime", "SetupComplete", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_Terms"],
  ...
  SchoolWhereInput: ["AND", "OR", "NOT", "SchoolID", "FK_Course", "Name", "HasClassSupport", "TermType"],
  SchoolOrderByWithRelationInput: ["SchoolID", "FK_Course", "Name", "HasClassSupport", "TermType"],
  ...
  FlowWhereInput: ["AND", "OR", "NOT", "FlowID", "CreatedTime", "FK_FlashCardStacks", "Title", "Body", "Visibility", "CourseOnTerm", "courseOnTermCourseOnTermID"],
  FlowOrderByWithRelationInput: ["FlowID", "CreatedTime", "FK_FlashCardStacks", "Title", "Body", "Visibility", "CourseOnTerm", "courseOnTermCourseOnTermID"],
  FlowWhereUniqueInput: ["FlowID"],
  FlowOrderByWithAggregationInput: ["FlowID", "CreatedTime", "Title", "Body", "Visibility", "courseOnTermCourseOnTermID", "_count", "_avg", "_max", "_min", "_sum"],
  FlowScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "FlowID", "CreatedTime", "Title", "Body", "Visibility", "courseOnTermCourseOnTermID"],
  ...
  UserCreateInput: ["CreatedTime", "SetupComplete", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_Terms"],
  UserUpdateInput: ["CreatedTime", "SetupComplete", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_Terms"],
  ...
  SchoolCreateInput: ["FK_Course", "Name", "HasClassSupport", "TermType"],
  SchoolUpdateInput: ["FK_Course", "Name", "HasClassSupport", "TermType"],
  ...
  FlowCreateInput: ["CreatedTime", "FK_FlashCardStacks", "Title", "Body", "Visibility", "CourseOnTerm"],
  FlowUpdateInput: ["CreatedTime", "FK_FlashCardStacks", "Title", "Body", "Visibility", "CourseOnTerm"],
  FlowCreateManyInput: ["FlowID", "CreatedTime", "Title", "Body", "Visibility", "courseOnTermCourseOnTermID"],
  ...
  FlowCountOrderByAggregateInput: ["FlowID", "CreatedTime", "Title", "Body", "Visibility", "courseOnTermCourseOnTermID"],
  FlowAvgOrderByAggregateInput: ["FlowID", "courseOnTermCourseOnTermID"],
  FlowMaxOrderByAggregateInput: ["FlowID", "CreatedTime", "Title", "Body", "Visibility", "courseOnTermCourseOnTermID"],
  FlowMinOrderByAggregateInput: ["FlowID", "CreatedTime", "Title", "Body", "Visibility", "courseOnTermCourseOnTermID"],
  FlowSumOrderByAggregateInput: ["FlowID", "courseOnTermCourseOnTermID"],
  ...
  FlowCreateNestedManyWithoutCourseOnTermInput: ["create", "connectOrCreate", "createMany", "connect"],
  CourseUpdateOneWithoutFK_TermsOnCourseInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  TermUpdateOneWithoutFK_CourseOnTermInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  FlowUpdateManyWithoutCourseOnTermInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  UserCreateWithoutFK_TermsInput: ["CreatedTime", "SetupComplete", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility"],
  ...
  UserUpdateWithoutFK_TermsInput: ["CreatedTime", "SetupComplete", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility"],
  ...
  FlowCreateWithoutCourseOnTermInput: ["CreatedTime", "FK_FlashCardStacks", "Title", "Body", "Visibility"],
  FlowCreateOrConnectWithoutCourseOnTermInput: ["where", "create"],
  FlowCreateManyCourseOnTermInputEnvelope: ["data", "skipDuplicates"],
  ...
  FlowUpsertWithWhereUniqueWithoutCourseOnTermInput: ["where", "update", "create"],
  FlowUpdateWithWhereUniqueWithoutCourseOnTermInput: ["where", "data"],
  FlowUpdateManyWithWhereWithoutCourseOnTermInput: ["where", "data"],
  FlowScalarWhereInput: ["AND", "OR", "NOT", "FlowID", "CreatedTime", "Title", "Body", "Visibility", "courseOnTermCourseOnTermID"],
  SchoolCreateWithoutFK_CourseInput: ["Name", "HasClassSupport", "TermType"],
  ...
  SchoolUpdateWithoutFK_CourseInput: ["Name", "HasClassSupport", "TermType"],
  ...
  FlowCreateWithoutFK_FlashCardStacksInput: ["CreatedTime", "Title", "Body", "Visibility", "CourseOnTerm"],
  ...
  FlowUpdateWithoutFK_FlashCardStacksInput: ["CreatedTime", "Title", "Body", "Visibility", "CourseOnTerm"],
  ...
  FlowCreateManyCourseOnTermInput: ["FlowID", "CreatedTime", "Title", "Body", "Visibility"],
  FlowUpdateWithoutCourseOnTermInput: ["CreatedTime", "FK_FlashCardStacks", "Title", "Body", "Visibility"],
