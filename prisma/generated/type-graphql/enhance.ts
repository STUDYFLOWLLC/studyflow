...
const relationResolversInfo = {
  Setting: ["FK_User"],
  User: ["FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView"],
  ...
  Flow: ["FK_CourseOnTerm", "FK_FlashCardStacks", "FK_Tasks", "FK_FlowView"],
...
const modelsInfo = {
  ...
  User: ["UserID", "CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_SchoolID"],
  ...
  Flow: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTermID"],
...
const outputsInfo = {
  ...
  UserGroupBy: ["UserID", "CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_SchoolID", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  FlowGroupBy: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTermID", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  UserCount: ["FK_Terms", "FK_Task", "FK_FlowView"],
  UserCountAggregate: ["UserID", "CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_SchoolID", "_all"],
  UserAvgAggregate: ["UserID", "FK_SchoolID"],
  UserSumAggregate: ["UserID", "FK_SchoolID"],
  UserMinAggregate: ["UserID", "CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_SchoolID"],
  UserMaxAggregate: ["UserID", "CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_SchoolID"],
  ...
  FlowCountAggregate: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTermID", "_all"],
  FlowAvgAggregate: ["FK_CourseOnTermID"],
  FlowSumAggregate: ["FK_CourseOnTermID"],
  FlowMinAggregate: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTermID"],
  FlowMaxAggregate: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTermID"],
...
const inputsInfo = {
  ...
  UserWhereInput: ["AND", "OR", "NOT", "UserID", "CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_School", "FK_SchoolID", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView"],
  UserOrderByWithRelationInput: ["UserID", "CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_School", "FK_SchoolID", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView"],
  UserWhereUniqueInput: ["UserID", "Email"],
  UserOrderByWithAggregationInput: ["UserID", "CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_SchoolID", "_count", "_avg", "_max", "_min", "_sum"],
  UserScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "UserID", "CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_SchoolID"],
  ...
  FlowWhereInput: ["AND", "OR", "NOT", "FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTerm", "FK_CourseOnTermID", "FK_FlashCardStacks", "FK_Tasks", "FK_FlowView"],
  FlowOrderByWithRelationInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTerm", "FK_CourseOnTermID", "FK_FlashCardStacks", "FK_Tasks", "FK_FlowView"],
  FlowWhereUniqueInput: ["FlowID"],
  FlowOrderByWithAggregationInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTermID", "_count", "_avg", "_max", "_min", "_sum"],
  FlowScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTermID"],
  ...
  UserCreateInput: ["CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView"],
  UserUpdateInput: ["CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView"],
  UserCreateManyInput: ["UserID", "CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_SchoolID"],
  UserUpdateManyMutationInput: ["CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility"],
  ...
  FlowCreateInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTerm", "FK_FlashCardStacks", "FK_Tasks", "FK_FlowView"],
  FlowUpdateInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTerm", "FK_FlashCardStacks", "FK_Tasks", "FK_FlowView"],
  FlowCreateManyInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTermID"],
  FlowUpdateManyMutationInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility"],
  ...
  UserCountOrderByAggregateInput: ["UserID", "CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_SchoolID"],
  UserAvgOrderByAggregateInput: ["UserID", "FK_SchoolID"],
  UserMaxOrderByAggregateInput: ["UserID", "CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_SchoolID"],
  UserMinOrderByAggregateInput: ["UserID", "CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_SchoolID"],
  ...
  FlowCountOrderByAggregateInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTermID"],
  FlowAvgOrderByAggregateInput: ["FK_CourseOnTermID"],
  FlowMaxOrderByAggregateInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTermID"],
  FlowMinOrderByAggregateInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTermID"],
  ...
  UserCreateWithoutFK_SettingsInput: ["CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_School", "FK_Terms", "FK_Task", "FK_FlowView"],
  UserCreateOrConnectWithoutFK_SettingsInput: ["where", "create"],
  UserUpsertWithoutFK_SettingsInput: ["update", "create"],
  UserUpdateWithoutFK_SettingsInput: ["CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_School", "FK_Terms", "FK_Task", "FK_FlowView"],
  ...
  UserCreateWithoutFK_TermsInput: ["CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_School", "FK_Task", "FK_Settings", "FK_FlowView"],
  ...
  UserUpdateWithoutFK_TermsInput: ["CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_School", "FK_Task", "FK_Settings", "FK_FlowView"],
  ...
  FlowCreateWithoutFK_CourseOnTermInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_FlashCardStacks", "FK_Tasks", "FK_FlowView"],
  ...
  FlowScalarWhereInput: ["AND", "OR", "NOT", "FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTermID"],
  ...
  UserCreateWithoutFK_SchoolInput: ["CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView"],
  ...
  UserScalarWhereInput: ["AND", "OR", "NOT", "UserID", "CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_SchoolID"],
  ...
  FlowCreateWithoutFK_FlowViewInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTerm", "FK_FlashCardStacks", "FK_Tasks"],
  FlowCreateOrConnectWithoutFK_FlowViewInput: ["where", "create"],
  UserCreateWithoutFK_FlowViewInput: ["CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_School", "FK_Terms", "FK_Task", "FK_Settings"],
  UserCreateOrConnectWithoutFK_FlowViewInput: ["where", "create"],
  FlowUpsertWithoutFK_FlowViewInput: ["update", "create"],
  FlowUpdateWithoutFK_FlowViewInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTerm", "FK_FlashCardStacks", "FK_Tasks"],
  UserUpsertWithoutFK_FlowViewInput: ["update", "create"],
  UserUpdateWithoutFK_FlowViewInput: ["CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_School", "FK_Terms", "FK_Task", "FK_Settings"],
  FlowCreateWithoutFK_FlashCardStacksInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTerm", "FK_Tasks", "FK_FlowView"],
  ...
  FlowUpdateWithoutFK_FlashCardStacksInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTerm", "FK_Tasks", "FK_FlowView"],
  ...
  UserCreateWithoutFK_TaskInput: ["CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_School", "FK_Terms", "FK_Settings", "FK_FlowView"],
  UserCreateOrConnectWithoutFK_TaskInput: ["where", "create"],
  FlowCreateWithoutFK_TasksInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTerm", "FK_FlashCardStacks", "FK_FlowView"],
  ...
  UserUpdateWithoutFK_TaskInput: ["CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_School", "FK_Terms", "FK_Settings", "FK_FlowView"],
  FlowUpsertWithoutFK_TasksInput: ["update", "create"],
  FlowUpdateWithoutFK_TasksInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_CourseOnTerm", "FK_FlashCardStacks", "FK_FlowView"],
  ...
  FlowCreateManyFK_CourseOnTermInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility"],
  TaskCreateManyFK_CourseOnTermInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "Type", "FK_UserID", "FK_FlowID"],
  FlowUpdateWithoutFK_CourseOnTermInput: ["FlowID", "CreatedTime", "UserEnteredDate", "Type", "Title", "Body", "Visibility", "FK_FlashCardStacks", "FK_Tasks", "FK_FlowView"],
  ...
  UserCreateManyFK_SchoolInput: ["UserID", "CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility"],
  ...
  UserUpdateWithoutFK_SchoolInput: ["CreatedTime", "LastOpened", "SetupStep", "SupabaseID", "Email", "Name", "Username", "ProfilePictureLink", "DefaultVisibility", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView"],
