...
const relationResolversInfo = {
  ...
  User: ["FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  ...
  Flow: ["FK_CourseOnTerm", "FK_FlashcardStacks", "FK_Tasks", "FK_FlowView", "FK_User", "FK_Repetitions"],
  FlowView: ["FK_Flow", "FK_User"],
  FlashcardStack: ["FK_Flow", "FK_Flashcards", "FK_Repetition"],
  Flashcard: ["FK_FlashcardStack", "FK_FlashcardReviews"],
  FlashcardReview: ["FK_Flashcard"],
...
const modelsInfo = {
  ...
  FlashcardReview: ["FlashcardReviewID", "CreatedTime", "FK_FlashcardID", "Status"],
  ...
  Repetition: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_FlowID", "FK_FlashcardStackID"]
};
...
const outputsInfo = {
  ...
  FlashcardReviewGroupBy: ["FlashcardReviewID", "CreatedTime", "FK_FlashcardID", "Status", "_count", "_min", "_max"],
  ...
  RepetitionGroupBy: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_FlowID", "FK_FlashcardStackID", "_count", "_min", "_max"],
  ...
  UserCount: ["FK_Terms", "FK_Task", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  ...
  FlowCount: ["FK_FlashcardStacks", "FK_Tasks", "FK_FlowView", "FK_Repetitions"],
  ...
  FlashcardReviewCountAggregate: ["FlashcardReviewID", "CreatedTime", "FK_FlashcardID", "Status", "_all"],
  FlashcardReviewMinAggregate: ["FlashcardReviewID", "CreatedTime", "FK_FlashcardID", "Status"],
  FlashcardReviewMaxAggregate: ["FlashcardReviewID", "CreatedTime", "FK_FlashcardID", "Status"],
  ...
  RepetitionCountAggregate: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_FlowID", "FK_FlashcardStackID", "_all"],
  RepetitionMinAggregate: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_FlowID", "FK_FlashcardStackID"],
  RepetitionMaxAggregate: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_FlowID", "FK_FlashcardStackID"]
};
...
const inputsInfo = {
  ...
  UserWhereInput: ["AND", "OR", "NOT", "UserID", "CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_SchoolID", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  UserOrderByWithRelationInput: ["UserID", "CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_SchoolID", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  ...
  FlowWhereInput: ["AND", "OR", "NOT", "FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_CourseOnTerm", "FK_CourseOnTermID", "FK_FlashcardStacks", "FK_Tasks", "FK_FlowView", "FK_User", "FK_UserID", "FK_Repetitions"],
  FlowOrderByWithRelationInput: ["FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_CourseOnTerm", "FK_CourseOnTermID", "FK_FlashcardStacks", "FK_Tasks", "FK_FlowView", "FK_User", "FK_UserID", "FK_Repetitions"],
  ...
  FlashcardStackWhereInput: ["AND", "OR", "NOT", "FlashcardStackID", "CreatedTime", "DeletedTime", "FK_Flow", "FK_FlowID", "FK_Flashcards", "FK_Repetition", "Title", "Description"],
  FlashcardStackOrderByWithRelationInput: ["FlashcardStackID", "CreatedTime", "DeletedTime", "FK_Flow", "FK_FlowID", "FK_Flashcards", "FK_Repetition", "Title", "Description"],
  ...
  FlashcardReviewWhereInput: ["AND", "OR", "NOT", "FlashcardReviewID", "CreatedTime", "FK_Flashcard", "FK_FlashcardID", "Status"],
  FlashcardReviewOrderByWithRelationInput: ["FlashcardReviewID", "CreatedTime", "FK_Flashcard", "FK_FlashcardID", "Status"],
  FlashcardReviewWhereUniqueInput: ["FlashcardReviewID"],
  FlashcardReviewOrderByWithAggregationInput: ["FlashcardReviewID", "CreatedTime", "FK_FlashcardID", "Status", "_count", "_max", "_min"],
  FlashcardReviewScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "FlashcardReviewID", "CreatedTime", "FK_FlashcardID", "Status"],
  ...
  RepetitionWhereInput: ["AND", "OR", "NOT", "RepetitionID", "CreatedTime", "RepetitionType", "FK_Flow", "FK_FlowID", "FK_FlashcardStack", "FK_FlashcardStackID", "FK_Tasks"],
  RepetitionOrderByWithRelationInput: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_Flow", "FK_FlowID", "FK_FlashcardStack", "FK_FlashcardStackID", "FK_Tasks"],
  RepetitionWhereUniqueInput: ["RepetitionID", "FK_FlashcardStackID"],
  RepetitionOrderByWithAggregationInput: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_FlowID", "FK_FlashcardStackID", "_count", "_max", "_min"],
  RepetitionScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "RepetitionID", "CreatedTime", "RepetitionType", "FK_FlowID", "FK_FlashcardStackID"],
  ...
  FriendshipCreateInput: ["SentTime", "AcceptedTime", "RejectedTime", "RemovedTime", "CanceledTime", "FK_UserFrom", "FK_UserTo"],
  FriendshipUpdateInput: ["SentTime", "AcceptedTime", "RejectedTime", "RemovedTime", "CanceledTime", "FK_UserFrom", "FK_UserTo"],
  ...
  FriendshipUpdateManyMutationInput: ["SentTime", "AcceptedTime", "RejectedTime", "RemovedTime", "CanceledTime"],
  ...
  UserCreateInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  UserUpdateInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  ...
  FlowCreateInput: ["FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_CourseOnTerm", "FK_FlashcardStacks", "FK_Tasks", "FK_FlowView", "FK_User", "FK_Repetitions"],
  FlowUpdateInput: ["FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_CourseOnTerm", "FK_FlashcardStacks", "FK_Tasks", "FK_FlowView", "FK_User", "FK_Repetitions"],
  ...
  FlashcardStackCreateInput: ["FlashcardStackID", "CreatedTime", "DeletedTime", "FK_Flow", "FK_Flashcards", "FK_Repetition", "Title", "Description"],
  FlashcardStackUpdateInput: ["FlashcardStackID", "CreatedTime", "DeletedTime", "FK_Flow", "FK_Flashcards", "FK_Repetition", "Title", "Description"],
  ...
  FlashcardReviewCreateInput: ["FlashcardReviewID", "CreatedTime", "FK_Flashcard", "Status"],
  FlashcardReviewUpdateInput: ["FlashcardReviewID", "CreatedTime", "FK_Flashcard", "Status"],
  FlashcardReviewCreateManyInput: ["FlashcardReviewID", "CreatedTime", "FK_FlashcardID", "Status"],
  ...
  RepetitionCreateInput: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_Flow", "FK_FlashcardStack", "FK_Tasks"],
  RepetitionUpdateInput: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_Flow", "FK_FlashcardStack", "FK_Tasks"],
  RepetitionCreateManyInput: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_FlowID", "FK_FlashcardStackID"],
  RepetitionUpdateManyMutationInput: ["RepetitionID", "CreatedTime", "RepetitionType"],
  ...
  RepetitionListRelationFilter: ["every", "some", "none"],
  FlashcardStackOrderByRelationAggregateInput: ["_count"],
  RepetitionOrderByRelationAggregateInput: ["_count"],
  ...
  FlashcardReviewCountOrderByAggregateInput: ["FlashcardReviewID", "CreatedTime", "FK_FlashcardID", "Status"],
  FlashcardReviewMaxOrderByAggregateInput: ["FlashcardReviewID", "CreatedTime", "FK_FlashcardID", "Status"],
  FlashcardReviewMinOrderByAggregateInput: ["FlashcardReviewID", "CreatedTime", "FK_FlashcardID", "Status"],
  ...
  RepetitionCountOrderByAggregateInput: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_FlowID", "FK_FlashcardStackID"],
  RepetitionMaxOrderByAggregateInput: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_FlowID", "FK_FlashcardStackID"],
  RepetitionMinOrderByAggregateInput: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_FlowID", "FK_FlashcardStackID"],
  ...
  RepetitionCreateNestedManyWithoutFK_FlowInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  RepetitionUpdateManyWithoutFK_FlowInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  FlowCreateNestedOneWithoutFK_RepetitionsInput: ["create", "connectOrCreate", "connect"],
  ...
  FlowUpdateOneWithoutFK_RepetitionsInput: ["create", "connectOrCreate", "upsert", "disconnect", "delete", "connect", "update"],
  ...
  UserCreateWithoutFK_SettingsInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  UserCreateOrConnectWithoutFK_SettingsInput: ["where", "create"],
  UserUpsertWithoutFK_SettingsInput: ["update", "create"],
  UserUpdateWithoutFK_SettingsInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  ...
  UserCreateWithoutFK_FriendshipsInitiatedInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsAccepted"],
  UserCreateOrConnectWithoutFK_FriendshipsInitiatedInput: ["where", "create"],
  UserCreateWithoutFK_FriendshipsAcceptedInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated"],
  ...
  UserUpdateWithoutFK_FriendshipsInitiatedInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsAccepted"],
  UserUpsertWithoutFK_FriendshipsAcceptedInput: ["update", "create"],
  UserUpdateWithoutFK_FriendshipsAcceptedInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated"],
  ...
  UserCreateWithoutFK_AutomationInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  ...
  UserUpdateWithoutFK_AutomationInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  UserCreateWithoutFK_UserOnStudyGroupsInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  ...
  UserUpdateWithoutFK_UserOnStudyGroupsInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  ...
  UserCreateWithoutFK_StudyGroupsInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  ...
  UserUpdateWithoutFK_StudyGroupsInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  ...
  FlowCreateWithoutFK_UserInput: ["FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_CourseOnTerm", "FK_FlashcardStacks", "FK_Tasks", "FK_FlowView", "FK_Repetitions"],
  ...
  FriendshipCreateWithoutFK_UserFromInput: ["SentTime", "AcceptedTime", "RejectedTime", "RemovedTime", "CanceledTime", "FK_UserTo"],
  ...
  FriendshipCreateWithoutFK_UserToInput: ["SentTime", "AcceptedTime", "RejectedTime", "RemovedTime", "CanceledTime", "FK_UserFrom"],
  ...
  UserCreateWithoutFK_TermsInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  ...
  UserUpdateWithoutFK_TermsInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  ...
  FlowCreateWithoutFK_CourseOnTermInput: ["FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_FlashcardStacks", "FK_Tasks", "FK_FlowView", "FK_User", "FK_Repetitions"],
  ...
  UserCreateWithoutFK_SchoolInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  ...
  FlashcardStackCreateWithoutFK_FlowInput: ["FlashcardStackID", "CreatedTime", "DeletedTime", "FK_Flashcards", "FK_Repetition", "Title", "Description"],
  ...
  UserCreateWithoutFK_FlowInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  UserCreateOrConnectWithoutFK_FlowInput: ["where", "create"],
  RepetitionCreateWithoutFK_FlowInput: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_FlashcardStack", "FK_Tasks"],
  RepetitionCreateOrConnectWithoutFK_FlowInput: ["where", "create"],
  RepetitionCreateManyFK_FlowInputEnvelope: ["data", "skipDuplicates"],
  ...
  UserUpdateWithoutFK_FlowInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  RepetitionUpsertWithWhereUniqueWithoutFK_FlowInput: ["where", "update", "create"],
  RepetitionUpdateWithWhereUniqueWithoutFK_FlowInput: ["where", "data"],
  RepetitionUpdateManyWithWhereWithoutFK_FlowInput: ["where", "data"],
  RepetitionScalarWhereInput: ["AND", "OR", "NOT", "RepetitionID", "CreatedTime", "RepetitionType", "FK_FlowID", "FK_FlashcardStackID"],
  FlowCreateWithoutFK_FlowViewInput: ["FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_CourseOnTerm", "FK_FlashcardStacks", "FK_Tasks", "FK_User", "FK_Repetitions"],
  FlowCreateOrConnectWithoutFK_FlowViewInput: ["where", "create"],
  UserCreateWithoutFK_FlowViewInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  UserCreateOrConnectWithoutFK_FlowViewInput: ["where", "create"],
  FlowUpsertWithoutFK_FlowViewInput: ["update", "create"],
  FlowUpdateWithoutFK_FlowViewInput: ["FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_CourseOnTerm", "FK_FlashcardStacks", "FK_Tasks", "FK_User", "FK_Repetitions"],
  UserUpsertWithoutFK_FlowViewInput: ["update", "create"],
  UserUpdateWithoutFK_FlowViewInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Task", "FK_Settings", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  FlowCreateWithoutFK_FlashcardStacksInput: ["FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_CourseOnTerm", "FK_Tasks", "FK_FlowView", "FK_User", "FK_Repetitions"],
  ...
  RepetitionCreateWithoutFK_FlashcardStackInput: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_Flow", "FK_Tasks"],
  ...
  FlowUpdateWithoutFK_FlashcardStacksInput: ["FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_CourseOnTerm", "FK_Tasks", "FK_FlowView", "FK_User", "FK_Repetitions"],
  ...
  RepetitionUpdateWithoutFK_FlashcardStackInput: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_Flow", "FK_Tasks"],
  FlashcardStackCreateWithoutFK_FlashcardsInput: ["FlashcardStackID", "CreatedTime", "DeletedTime", "FK_Flow", "FK_Repetition", "Title", "Description"],
  FlashcardStackCreateOrConnectWithoutFK_FlashcardsInput: ["where", "create"],
  FlashcardReviewCreateWithoutFK_FlashcardInput: ["FlashcardReviewID", "CreatedTime", "Status"],
  ...
  FlashcardStackUpdateWithoutFK_FlashcardsInput: ["FlashcardStackID", "CreatedTime", "DeletedTime", "FK_Flow", "FK_Repetition", "Title", "Description"],
  ...
  FlashcardReviewScalarWhereInput: ["AND", "OR", "NOT", "FlashcardReviewID", "CreatedTime", "FK_FlashcardID", "Status"],
  ...
  UserCreateWithoutFK_TaskInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  UserCreateOrConnectWithoutFK_TaskInput: ["where", "create"],
  FlowCreateWithoutFK_TasksInput: ["FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_CourseOnTerm", "FK_FlashcardStacks", "FK_FlowView", "FK_User", "FK_Repetitions"],
  ...
  RepetitionCreateWithoutFK_TasksInput: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_Flow", "FK_FlashcardStack"],
  ...
  UserUpdateWithoutFK_TaskInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_School", "FK_Terms", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  FlowUpsertWithoutFK_TasksInput: ["update", "create"],
  FlowUpdateWithoutFK_TasksInput: ["FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_CourseOnTerm", "FK_FlashcardStacks", "FK_FlowView", "FK_User", "FK_Repetitions"],
  ...
  RepetitionUpdateWithoutFK_TasksInput: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_Flow", "FK_FlashcardStack"],
  ...
  FlowCreateWithoutFK_RepetitionsInput: ["FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_CourseOnTerm", "FK_FlashcardStacks", "FK_Tasks", "FK_FlowView", "FK_User"],
  FlowCreateOrConnectWithoutFK_RepetitionsInput: ["where", "create"],
  FlashcardStackCreateWithoutFK_RepetitionInput: ["FlashcardStackID", "CreatedTime", "DeletedTime", "FK_Flow", "FK_Flashcards", "Title", "Description"],
  ...
  FlowUpsertWithoutFK_RepetitionsInput: ["update", "create"],
  FlowUpdateWithoutFK_RepetitionsInput: ["FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_CourseOnTerm", "FK_FlashcardStacks", "FK_Tasks", "FK_FlowView", "FK_User"],
  FlashcardStackUpsertWithoutFK_RepetitionInput: ["update", "create"],
  FlashcardStackUpdateWithoutFK_RepetitionInput: ["FlashcardStackID", "CreatedTime", "DeletedTime", "FK_Flow", "FK_Flashcards", "Title", "Description"],
  ...
  FlowUpdateWithoutFK_UserInput: ["FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_CourseOnTerm", "FK_FlashcardStacks", "FK_Tasks", "FK_FlowView", "FK_Repetitions"],
  ...
  FriendshipUpdateWithoutFK_UserFromInput: ["SentTime", "AcceptedTime", "RejectedTime", "RemovedTime", "CanceledTime", "FK_UserTo"],
  FriendshipUpdateWithoutFK_UserToInput: ["SentTime", "AcceptedTime", "RejectedTime", "RemovedTime", "CanceledTime", "FK_UserFrom"],
  ...
  FlowUpdateWithoutFK_CourseOnTermInput: ["FlowID", "CreatedTime", "LastOpened", "UserEnteredDate", "Type", "Title", "Trashed", "Visibility", "WasAutomated", "Body", "DeletedTime", "FK_FlashcardStacks", "FK_Tasks", "FK_FlowView", "FK_User", "FK_Repetitions"],
  ...
  UserUpdateWithoutFK_SchoolInput: ["CreatedTime", "SetupStep", "SupabaseID", "DefaultVisibility", "Email", "Bio", "About", "Name", "Username", "ProfilePictureLink", "FK_Terms", "FK_Task", "FK_Settings", "FK_FlowView", "FK_Flow", "FK_Automation", "FK_StudyGroups", "FK_UserOnStudyGroups", "FK_FriendshipsInitiated", "FK_FriendshipsAccepted"],
  ...
  RepetitionCreateManyFK_FlowInput: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_FlashcardStackID"],
  FlashcardStackUpdateWithoutFK_FlowInput: ["FlashcardStackID", "CreatedTime", "DeletedTime", "FK_Flashcards", "FK_Repetition", "Title", "Description"],
  ...
  RepetitionUpdateWithoutFK_FlowInput: ["RepetitionID", "CreatedTime", "RepetitionType", "FK_FlashcardStack", "FK_Tasks"],
  ...
  FlashcardReviewCreateManyFK_FlashcardInput: ["FlashcardReviewID", "CreatedTime", "Status"],
  FlashcardReviewUpdateWithoutFK_FlashcardInput: ["FlashcardReviewID", "CreatedTime", "Status"],
