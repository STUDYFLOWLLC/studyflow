...
const modelsInfo = {
  ...
  Task: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_UserID", "FK_FlowID", "FK_CourseOnTermID"],
...
const outputsInfo = {
  ...
  TaskGroupBy: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_UserID", "FK_FlowID", "FK_CourseOnTermID", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  TaskCountAggregate: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_UserID", "FK_FlowID", "FK_CourseOnTermID", "_all"],
  TaskAvgAggregate: ["TaskID", "FK_UserID", "FK_CourseOnTermID"],
  TaskSumAggregate: ["TaskID", "FK_UserID", "FK_CourseOnTermID"],
  TaskMinAggregate: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_UserID", "FK_FlowID", "FK_CourseOnTermID"],
  TaskMaxAggregate: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_UserID", "FK_FlowID", "FK_CourseOnTermID"],
  TaskLabelCountAggregate: ["TaskLabelID", "CreatedTime", "Label", "FK_TaskID", "_all"],
  TaskLabelAvgAggregate: ["TaskLabelID", "FK_TaskID"],
  TaskLabelSumAggregate: ["TaskLabelID", "FK_TaskID"],
...
const inputsInfo = {
  ...
  TaskWhereInput: ["AND", "OR", "NOT", "TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_User", "FK_UserID", "FK_Flow", "FK_FlowID", "FK_CourseOnTerm", "FK_CourseOnTermID"],
  TaskOrderByWithRelationInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_User", "FK_UserID", "FK_Flow", "FK_FlowID", "FK_CourseOnTerm", "FK_CourseOnTermID"],
  TaskWhereUniqueInput: ["TaskID"],
  TaskOrderByWithAggregationInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_UserID", "FK_FlowID", "FK_CourseOnTermID", "_count", "_avg", "_max", "_min", "_sum"],
  TaskScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_UserID", "FK_FlowID", "FK_CourseOnTermID"],
  ...
  TaskCreateInput: ["CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_User", "FK_Flow", "FK_CourseOnTerm"],
  TaskUpdateInput: ["CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_User", "FK_Flow", "FK_CourseOnTerm"],
  TaskCreateManyInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_UserID", "FK_FlowID", "FK_CourseOnTermID"],
  TaskUpdateManyMutationInput: ["CreatedTime", "Title", "Completed", "Description", "DueDate"],
  ...
  TaskCountOrderByAggregateInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_UserID", "FK_FlowID", "FK_CourseOnTermID"],
  TaskAvgOrderByAggregateInput: ["TaskID", "FK_UserID", "FK_CourseOnTermID"],
  TaskMaxOrderByAggregateInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_UserID", "FK_FlowID", "FK_CourseOnTermID"],
  TaskMinOrderByAggregateInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_UserID", "FK_FlowID", "FK_CourseOnTermID"],
  TaskSumOrderByAggregateInput: ["TaskID", "FK_UserID", "FK_CourseOnTermID"],
  DateTimeNullableWithAggregatesFilter: ["equals", "in", "notIn", "lt", "lte", "gt", "gte", "not", "_count", "_min", "_max"],
  TaskRelationFilter: ["is", "isNot"],
  TaskLabelCountOrderByAggregateInput: ["TaskLabelID", "CreatedTime", "Label", "FK_TaskID"],
  TaskLabelAvgOrderByAggregateInput: ["TaskLabelID", "FK_TaskID"],
  ...
  TaskLabelSumOrderByAggregateInput: ["TaskLabelID", "FK_TaskID"],
  ...
  TaskCreateWithoutFK_UserInput: ["CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_Flow", "FK_CourseOnTerm"],
  ...
  TaskScalarWhereInput: ["AND", "OR", "NOT", "TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_UserID", "FK_FlowID", "FK_CourseOnTermID"],
  ...
  TaskCreateWithoutFK_CourseOnTermInput: ["CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_User", "FK_Flow"],
  ...
  TaskCreateWithoutFK_FlowInput: ["CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_User", "FK_CourseOnTerm"],
  ...
  TaskCreateWithoutFK_TaskLabelInput: ["CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_User", "FK_Flow", "FK_CourseOnTerm"],
  TaskCreateOrConnectWithoutFK_TaskLabelInput: ["where", "create"],
  TaskUpsertWithoutFK_TaskLabelInput: ["update", "create"],
  TaskUpdateWithoutFK_TaskLabelInput: ["CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_User", "FK_Flow", "FK_CourseOnTerm"],
  TermCreateManyFK_UserInput: ["TermID", "CreatedTime", "TermType", "TermName", "FK_SchoolID"],
  TaskCreateManyFK_UserInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_FlowID", "FK_CourseOnTermID"],
  TermUpdateWithoutFK_UserInput: ["CreatedTime", "TermType", "TermName", "FK_School", "FK_CourseOnTerm"],
  TaskUpdateWithoutFK_UserInput: ["CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_Flow", "FK_CourseOnTerm"],
  ...
  TaskCreateManyFK_CourseOnTermInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_UserID", "FK_FlowID"],
  FlowUpdateWithoutFK_CourseOnTermInput: ["FlowID", "CreatedTime", "Type", "Title", "Body", "Visibility", "FK_FlashCardStacks", "FK_Tasks"],
  TaskUpdateWithoutFK_CourseOnTermInput: ["CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_User", "FK_Flow"],
  ...
  TaskCreateManyFK_FlowInput: ["TaskID", "CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_UserID", "FK_CourseOnTermID"],
  FlashCardStackUpdateWithoutFK_FlowInput: ["CreatedTime", "FlashCards", "Title"],
  TaskUpdateWithoutFK_FlowInput: ["CreatedTime", "Title", "Completed", "Description", "DueDate", "FK_TaskLabel", "FK_User", "FK_CourseOnTerm"],
