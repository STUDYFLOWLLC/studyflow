...
const inputsInfo = {
  ...
  AutomationWhereInput: ["AND", "OR", "NOT", "AutomationID", "RefreshToken", "FK_User", "FK_UserID"],
  AutomationOrderByWithRelationInput: ["AutomationID", "RefreshToken", "FK_User", "FK_UserID"],
  ...
  CourseOnTermWhereInput: ["AND", "OR", "NOT", "CourseOnTermID", "CreatedTime", "Index", "Color", "Nickname", "IsNew", "FK_Course", "FK_CourseID", "FK_Term", "FK_TermID", "FK_Flows", "FK_Tasks"],
  CourseOnTermOrderByWithRelationInput: ["CourseOnTermID", "CreatedTime", "Index", "Color", "Nickname", "IsNew", "FK_Course", "FK_CourseID", "FK_Term", "FK_TermID", "FK_Flows", "FK_Tasks"],
  ...
  AutomationCreateInput: ["RefreshToken", "FK_User"],
  AutomationUpdateInput: ["RefreshToken", "FK_User"],
  ...
  CourseOnTermCreateInput: ["CreatedTime", "Index", "Color", "Nickname", "IsNew", "FK_Course", "FK_Term", "FK_Flows", "FK_Tasks"],
  CourseOnTermUpdateInput: ["CreatedTime", "Index", "Color", "Nickname", "IsNew", "FK_Course", "FK_Term", "FK_Flows", "FK_Tasks"],
  ...
  AutomationCreateWithoutFK_UserInput: ["RefreshToken"],
  ...
  CourseOnTermCreateWithoutFK_TermInput: ["CreatedTime", "Index", "Color", "Nickname", "IsNew", "FK_Course", "FK_Flows", "FK_Tasks"],
  ...
  CourseOnTermCreateWithoutFK_CourseInput: ["CreatedTime", "Index", "Color", "Nickname", "IsNew", "FK_Term", "FK_Flows", "FK_Tasks"],
  ...
  CourseOnTermCreateWithoutFK_FlowsInput: ["CreatedTime", "Index", "Color", "Nickname", "IsNew", "FK_Course", "FK_Term", "FK_Tasks"],
  ...
  CourseOnTermUpdateWithoutFK_FlowsInput: ["CreatedTime", "Index", "Color", "Nickname", "IsNew", "FK_Course", "FK_Term", "FK_Tasks"],
  ...
  CourseOnTermCreateWithoutFK_TasksInput: ["CreatedTime", "Index", "Color", "Nickname", "IsNew", "FK_Course", "FK_Term", "FK_Flows"],
  ...
  CourseOnTermUpdateWithoutFK_TasksInput: ["CreatedTime", "Index", "Color", "Nickname", "IsNew", "FK_Course", "FK_Term", "FK_Flows"],
  ...
  AutomationUpdateWithoutFK_UserInput: ["RefreshToken"],
  CourseOnTermCreateManyFK_TermInput: ["CourseOnTermID", "CreatedTime", "Index", "Color", "Nickname", "IsNew", "FK_CourseID"],
  CourseOnTermUpdateWithoutFK_TermInput: ["CreatedTime", "Index", "Color", "Nickname", "IsNew", "FK_Course", "FK_Flows", "FK_Tasks"],
  CourseOnTermCreateManyFK_CourseInput: ["CourseOnTermID", "CreatedTime", "Index", "Color", "Nickname", "IsNew", "FK_TermID"],
  CourseOnTermUpdateWithoutFK_CourseInput: ["CreatedTime", "Index", "Color", "Nickname", "IsNew", "FK_Term", "FK_Flows", "FK_Tasks"],
