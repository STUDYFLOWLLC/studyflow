...
const crudResolversMap = {
  ...
  ProfessorsOnCourses: crudResolvers.ProfessorsOnCoursesCrudResolver,
...
const actionResolversMap = {
  ...
  ProfessorsOnCourses: {
    findUniqueProfessorsOnCourses: actionResolvers.FindUniqueProfessorsOnCoursesResolver,
    findFirstProfessorsOnCourses: actionResolvers.FindFirstProfessorsOnCoursesResolver,
    findManyProfessorsOnCourses: actionResolvers.FindManyProfessorsOnCoursesResolver,
    createProfessorsOnCourses: actionResolvers.CreateProfessorsOnCoursesResolver,
    createManyProfessorsOnCourses: actionResolvers.CreateManyProfessorsOnCoursesResolver,
    deleteProfessorsOnCourses: actionResolvers.DeleteProfessorsOnCoursesResolver,
    updateProfessorsOnCourses: actionResolvers.UpdateProfessorsOnCoursesResolver,
    deleteManyProfessorsOnCourses: actionResolvers.DeleteManyProfessorsOnCoursesResolver,
    updateManyProfessorsOnCourses: actionResolvers.UpdateManyProfessorsOnCoursesResolver,
    upsertProfessorsOnCourses: actionResolvers.UpsertProfessorsOnCoursesResolver,
    aggregateProfessorsOnCourses: actionResolvers.AggregateProfessorsOnCoursesResolver,
    groupByProfessorsOnCourses: actionResolvers.GroupByProfessorsOnCoursesResolver
  },
  Flow: {
...
const crudResolversInfo = {
  ...
  ProfessorsOnCourses: ["findUniqueProfessorsOnCourses", "findFirstProfessorsOnCourses", "findManyProfessorsOnCourses", "createProfessorsOnCourses", "createManyProfessorsOnCourses", "deleteProfessorsOnCourses", "updateProfessorsOnCourses", "deleteManyProfessorsOnCourses", "updateManyProfessorsOnCourses", "upsertProfessorsOnCourses", "aggregateProfessorsOnCourses", "groupByProfessorsOnCourses"],
...
const argsInfo = {
  ...
  FindUniqueProfessorsOnCoursesArgs: ["where"],
  FindFirstProfessorsOnCoursesArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  FindManyProfessorsOnCoursesArgs: ["where", "orderBy", "cursor", "take", "skip", "distinct"],
  CreateProfessorsOnCoursesArgs: ["data"],
  CreateManyProfessorsOnCoursesArgs: ["data", "skipDuplicates"],
  DeleteProfessorsOnCoursesArgs: ["where"],
  UpdateProfessorsOnCoursesArgs: ["data", "where"],
  DeleteManyProfessorsOnCoursesArgs: ["where"],
  UpdateManyProfessorsOnCoursesArgs: ["data", "where"],
  UpsertProfessorsOnCoursesArgs: ["where", "create", "update"],
  AggregateProfessorsOnCoursesArgs: ["where", "orderBy", "cursor", "take", "skip"],
  GroupByProfessorsOnCoursesArgs: ["where", "orderBy", "by", "having", "take", "skip"],
...
const relationResolversMap = {
  ...
  ProfessorsOnCourses: relationResolvers.ProfessorsOnCoursesRelationsResolver,
...
const relationResolversInfo = {
  ...
  Course: ["FK_School", "FK_Professors", "FK_TermsOnCourse"],
  Professor: ["FK_Courses"],
  ProfessorsOnCourses: ["FK_Course", "FK_Professor"],
...
const modelsInfo = {
  ...
  Course: ["CourseID", "CreatedTime", "FK_SchoolID", "IsOfficial", "Code", "Title"],
  Professor: ["ProfessorID", "Name"],
  ProfessorsOnCourses: ["ProfessorsOnCoursesID", "CreatedTime", "FK_CourseID", "FK_ProfessorID"],
...
const outputsInfo = {
  ...
  CourseGroupBy: ["CourseID", "CreatedTime", "FK_SchoolID", "IsOfficial", "Code", "Title", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateProfessor: ["_count", "_avg", "_sum", "_min", "_max"],
  ProfessorGroupBy: ["ProfessorID", "Name", "_count", "_avg", "_sum", "_min", "_max"],
  AggregateProfessorsOnCourses: ["_count", "_avg", "_sum", "_min", "_max"],
  ProfessorsOnCoursesGroupBy: ["ProfessorsOnCoursesID", "CreatedTime", "FK_CourseID", "FK_ProfessorID", "_count", "_avg", "_sum", "_min", "_max"],
  ...
  CourseCount: ["FK_Professors", "FK_TermsOnCourse"],
  CourseCountAggregate: ["CourseID", "CreatedTime", "FK_SchoolID", "IsOfficial", "Code", "Title", "_all"],
  CourseAvgAggregate: ["CourseID", "FK_SchoolID"],
  CourseSumAggregate: ["CourseID", "FK_SchoolID"],
  CourseMinAggregate: ["CourseID", "CreatedTime", "FK_SchoolID", "IsOfficial", "Code", "Title"],
  CourseMaxAggregate: ["CourseID", "CreatedTime", "FK_SchoolID", "IsOfficial", "Code", "Title"],
  ProfessorCount: ["FK_Courses"],
  ProfessorCountAggregate: ["ProfessorID", "Name", "_all"],
  ProfessorAvgAggregate: ["ProfessorID"],
  ProfessorSumAggregate: ["ProfessorID"],
  ProfessorMinAggregate: ["ProfessorID", "Name"],
  ProfessorMaxAggregate: ["ProfessorID", "Name"],
  ProfessorsOnCoursesCountAggregate: ["ProfessorsOnCoursesID", "CreatedTime", "FK_CourseID", "FK_ProfessorID", "_all"],
  ProfessorsOnCoursesAvgAggregate: ["ProfessorsOnCoursesID", "FK_CourseID", "FK_ProfessorID"],
  ProfessorsOnCoursesSumAggregate: ["ProfessorsOnCoursesID", "FK_CourseID", "FK_ProfessorID"],
  ProfessorsOnCoursesMinAggregate: ["ProfessorsOnCoursesID", "CreatedTime", "FK_CourseID", "FK_ProfessorID"],
  ProfessorsOnCoursesMaxAggregate: ["ProfessorsOnCoursesID", "CreatedTime", "FK_CourseID", "FK_ProfessorID"],
...
const inputsInfo = {
  ...
  CourseWhereInput: ["AND", "OR", "NOT", "CourseID", "CreatedTime", "FK_School", "FK_SchoolID", "FK_Professors", "FK_TermsOnCourse", "IsOfficial", "Code", "Title"],
  CourseOrderByWithRelationInput: ["CourseID", "CreatedTime", "FK_School", "FK_SchoolID", "FK_Professors", "FK_TermsOnCourse", "IsOfficial", "Code", "Title"],
  CourseWhereUniqueInput: ["CourseID"],
  CourseOrderByWithAggregationInput: ["CourseID", "CreatedTime", "FK_SchoolID", "IsOfficial", "Code", "Title", "_count", "_avg", "_max", "_min", "_sum"],
  CourseScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "CourseID", "CreatedTime", "FK_SchoolID", "IsOfficial", "Code", "Title"],
  ProfessorWhereInput: ["AND", "OR", "NOT", "ProfessorID", "FK_Courses", "Name"],
  ProfessorOrderByWithRelationInput: ["ProfessorID", "FK_Courses", "Name"],
  ProfessorWhereUniqueInput: ["ProfessorID"],
  ProfessorOrderByWithAggregationInput: ["ProfessorID", "Name", "_count", "_avg", "_max", "_min", "_sum"],
  ProfessorScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "ProfessorID", "Name"],
  ProfessorsOnCoursesWhereInput: ["AND", "OR", "NOT", "ProfessorsOnCoursesID", "CreatedTime", "FK_Course", "FK_CourseID", "FK_Professor", "FK_ProfessorID"],
  ProfessorsOnCoursesOrderByWithRelationInput: ["ProfessorsOnCoursesID", "CreatedTime", "FK_Course", "FK_CourseID", "FK_Professor", "FK_ProfessorID"],
  ProfessorsOnCoursesWhereUniqueInput: ["ProfessorsOnCoursesID"],
  ProfessorsOnCoursesOrderByWithAggregationInput: ["ProfessorsOnCoursesID", "CreatedTime", "FK_CourseID", "FK_ProfessorID", "_count", "_avg", "_max", "_min", "_sum"],
  ProfessorsOnCoursesScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "ProfessorsOnCoursesID", "CreatedTime", "FK_CourseID", "FK_ProfessorID"],
  ...
  CourseCreateInput: ["CreatedTime", "FK_School", "FK_Professors", "FK_TermsOnCourse", "IsOfficial", "Code", "Title"],
  CourseUpdateInput: ["CreatedTime", "FK_School", "FK_Professors", "FK_TermsOnCourse", "IsOfficial", "Code", "Title"],
  CourseCreateManyInput: ["CourseID", "CreatedTime", "FK_SchoolID", "IsOfficial", "Code", "Title"],
  CourseUpdateManyMutationInput: ["CreatedTime", "IsOfficial", "Code", "Title"],
  ProfessorCreateInput: ["FK_Courses", "Name"],
  ProfessorUpdateInput: ["FK_Courses", "Name"],
  ProfessorCreateManyInput: ["ProfessorID", "Name"],
  ProfessorUpdateManyMutationInput: ["Name"],
  ProfessorsOnCoursesCreateInput: ["CreatedTime", "FK_Course", "FK_Professor"],
  ProfessorsOnCoursesUpdateInput: ["CreatedTime", "FK_Course", "FK_Professor"],
  ProfessorsOnCoursesCreateManyInput: ["ProfessorsOnCoursesID", "CreatedTime", "FK_CourseID", "FK_ProfessorID"],
  ProfessorsOnCoursesUpdateManyMutationInput: ["CreatedTime"],
  ...
  ProfessorsOnCoursesListRelationFilter: ["every", "some", "none"],
  ProfessorsOnCoursesOrderByRelationAggregateInput: ["_count"],
  CourseCountOrderByAggregateInput: ["CourseID", "CreatedTime", "FK_SchoolID", "IsOfficial", "Code", "Title"],
  CourseAvgOrderByAggregateInput: ["CourseID", "FK_SchoolID"],
  CourseMaxOrderByAggregateInput: ["CourseID", "CreatedTime", "FK_SchoolID", "IsOfficial", "Code", "Title"],
  CourseMinOrderByAggregateInput: ["CourseID", "CreatedTime", "FK_SchoolID", "IsOfficial", "Code", "Title"],
  CourseSumOrderByAggregateInput: ["CourseID", "FK_SchoolID"],
  ProfessorCountOrderByAggregateInput: ["ProfessorID", "Name"],
  ProfessorAvgOrderByAggregateInput: ["ProfessorID"],
  ProfessorMaxOrderByAggregateInput: ["ProfessorID", "Name"],
  ProfessorMinOrderByAggregateInput: ["ProfessorID", "Name"],
  ProfessorSumOrderByAggregateInput: ["ProfessorID"],
  ProfessorRelationFilter: ["is", "isNot"],
  ProfessorsOnCoursesCountOrderByAggregateInput: ["ProfessorsOnCoursesID", "CreatedTime", "FK_CourseID", "FK_ProfessorID"],
  ProfessorsOnCoursesAvgOrderByAggregateInput: ["ProfessorsOnCoursesID", "FK_CourseID", "FK_ProfessorID"],
  ProfessorsOnCoursesMaxOrderByAggregateInput: ["ProfessorsOnCoursesID", "CreatedTime", "FK_CourseID", "FK_ProfessorID"],
  ProfessorsOnCoursesMinOrderByAggregateInput: ["ProfessorsOnCoursesID", "CreatedTime", "FK_CourseID", "FK_ProfessorID"],
  ProfessorsOnCoursesSumOrderByAggregateInput: ["ProfessorsOnCoursesID", "FK_CourseID", "FK_ProfessorID"],
  ...
  ProfessorsOnCoursesCreateNestedManyWithoutFK_CourseInput: ["create", "connectOrCreate", "createMany", "connect"],
  ...
  ProfessorsOnCoursesUpdateManyWithoutFK_CourseInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  ProfessorsOnCoursesCreateNestedManyWithoutFK_ProfessorInput: ["create", "connectOrCreate", "createMany", "connect"],
  ProfessorsOnCoursesUpdateManyWithoutFK_ProfessorInput: ["create", "connectOrCreate", "upsert", "createMany", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  CourseUpdateOneRequiredWithoutFK_ProfessorsInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ProfessorUpdateOneRequiredWithoutFK_CoursesInput: ["create", "connectOrCreate", "upsert", "connect", "update"],
  ...
  CourseCreateWithoutFK_TermsOnCourseInput: ["CreatedTime", "FK_School", "FK_Professors", "IsOfficial", "Code", "Title"],
  ...
  CourseUpdateWithoutFK_TermsOnCourseInput: ["CreatedTime", "FK_School", "FK_Professors", "IsOfficial", "Code", "Title"],
  ...
  CourseCreateWithoutFK_SchoolInput: ["CreatedTime", "FK_Professors", "FK_TermsOnCourse", "IsOfficial", "Code", "Title"],
  ...
  CourseScalarWhereInput: ["AND", "OR", "NOT", "CourseID", "CreatedTime", "FK_SchoolID", "IsOfficial", "Code", "Title"],
  ...
  ProfessorsOnCoursesCreateWithoutFK_CourseInput: ["CreatedTime", "FK_Professor"],
  ProfessorsOnCoursesCreateOrConnectWithoutFK_CourseInput: ["where", "create"],
  ProfessorsOnCoursesCreateManyFK_CourseInputEnvelope: ["data", "skipDuplicates"],
  ...
  ProfessorsOnCoursesUpsertWithWhereUniqueWithoutFK_CourseInput: ["where", "update", "create"],
  ProfessorsOnCoursesUpdateWithWhereUniqueWithoutFK_CourseInput: ["where", "data"],
  ProfessorsOnCoursesUpdateManyWithWhereWithoutFK_CourseInput: ["where", "data"],
  ProfessorsOnCoursesScalarWhereInput: ["AND", "OR", "NOT", "ProfessorsOnCoursesID", "CreatedTime", "FK_CourseID", "FK_ProfessorID"],
  ...
  ProfessorsOnCoursesCreateWithoutFK_ProfessorInput: ["CreatedTime", "FK_Course"],
  ProfessorsOnCoursesCreateOrConnectWithoutFK_ProfessorInput: ["where", "create"],
  ProfessorsOnCoursesCreateManyFK_ProfessorInputEnvelope: ["data", "skipDuplicates"],
  ProfessorsOnCoursesUpsertWithWhereUniqueWithoutFK_ProfessorInput: ["where", "update", "create"],
  ProfessorsOnCoursesUpdateWithWhereUniqueWithoutFK_ProfessorInput: ["where", "data"],
  ProfessorsOnCoursesUpdateManyWithWhereWithoutFK_ProfessorInput: ["where", "data"],
  CourseCreateWithoutFK_ProfessorsInput: ["CreatedTime", "FK_School", "FK_TermsOnCourse", "IsOfficial", "Code", "Title"],
  CourseCreateOrConnectWithoutFK_ProfessorsInput: ["where", "create"],
  ProfessorCreateWithoutFK_CoursesInput: ["Name"],
  ProfessorCreateOrConnectWithoutFK_CoursesInput: ["where", "create"],
  CourseUpsertWithoutFK_ProfessorsInput: ["update", "create"],
  CourseUpdateWithoutFK_ProfessorsInput: ["CreatedTime", "FK_School", "FK_TermsOnCourse", "IsOfficial", "Code", "Title"],
  ProfessorUpsertWithoutFK_CoursesInput: ["update", "create"],
  ProfessorUpdateWithoutFK_CoursesInput: ["Name"],
  ...
  CourseCreateManyFK_SchoolInput: ["CourseID", "CreatedTime", "IsOfficial", "Code", "Title"],
  ...
  CourseUpdateWithoutFK_SchoolInput: ["CreatedTime", "FK_Professors", "FK_TermsOnCourse", "IsOfficial", "Code", "Title"],
  ...
  ProfessorsOnCoursesCreateManyFK_CourseInput: ["ProfessorsOnCoursesID", "CreatedTime", "FK_ProfessorID"],
  CourseOnTermCreateManyFK_CourseInput: ["CourseOnTermID", "CreatedTime", "FK_TermID"],
  ProfessorsOnCoursesUpdateWithoutFK_CourseInput: ["CreatedTime", "FK_Professor"],
  CourseOnTermUpdateWithoutFK_CourseInput: ["CreatedTime", "FK_Term", "FK_Flows"],
  ProfessorsOnCoursesCreateManyFK_ProfessorInput: ["ProfessorsOnCoursesID", "CreatedTime", "FK_CourseID"],
  ProfessorsOnCoursesUpdateWithoutFK_ProfessorInput: ["CreatedTime", "FK_Course"],
