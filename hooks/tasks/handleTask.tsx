...
import { archiveTask } from './mutateTask'
...
export function completeOrUncompleteTask(
  taskId: string,
  ...
  toast.custom(
    (t) =>
      show ? (
        ...
        >
          <div className="amimate-enter transition-all max-w-sm w-full bg-base-100 shadow-lg rounded-lg pointer-events-auto ring-1 ring-base-100 ring-opacity-5 overflow-hidden">
            <div className="p-4">
